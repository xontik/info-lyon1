...
{
    /**
     * @var DateTime Beginning of the Period
     */
    private $_beginDate;

    /**
     * @var DateTime End of the Period
     */
    private $_endDate;
    ...
    public function __construct($beginDate, $endDate)
    {
        if (!$beginDate instanceof DateTime) {
            throw new InvalidArgumentException('Begin date can only be a DateTime. Input was : ' . $beginDate);
        }
